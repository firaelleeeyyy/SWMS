...
function initNavbar() {
  ...
  const handleChatbotClick = () => {
    ...
    alert('Chatbot akan segera tersedia! Silakan hubungi kami melalui WhatsApp: +62 821-3985-9161');
  };
...
function initNavbar() {
  ...
  // Chatbot buttons
  const handleChatbotClick = () => {
    window.location.href = 'chatbot/Project_Chatbot/chatbot.html';
  };
...
function initFormValidation() {
  ...
  form.addEventListener('submit', function(e) {
    ...
    const whatsappNumber = '6282139859161';
    const text = encodeURIComponent(
      `Halo Global Auto Variasi, saya ingin bertanya terkait layanan berikut:
Nama: ${name}
Telepon: ${phone}
Layanan: ${service}
...
>>>>>>> 56ec0d3 (fixed webcompro+chatbot):Global Auto Variasi/script.js
}